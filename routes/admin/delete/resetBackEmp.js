...
router.delete("/resetBackEmp/:id", async (req, res) => {
  try {
    const employeeId = req.params.id;
    let sql = `Select * From resign_employeetab where Employee_Id=?`;
    connection.query(sql, [employeeId], async (err, results) => {
      ...
      sql = `DELETE FROM resign_employeetab WHERE Employee_Id=?`;
      ...
      let sql3 = `INSERT INTO employee_table (
